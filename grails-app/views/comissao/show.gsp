...
<html>
    ...
    <body>
        ...
        <div id="show-comissao" class="content scaffold-show" role="main">
            ...
            <f:display bean="comissao" />
            <g:form resource="${this.comissao}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.comissao}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
